...
public final class CreateLoanFlow {
    private CreateLoanFlow(){
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            Party agentBank = getOurIdentity();
            ...
            builder.addOutputState(loanState);
            builder.addCommand(
                    new LoanContract.Commands.Create(),
                    loanState.getParticipants().stream()
            ...
            List<FlowSession> cpSessions = loanState.getParticipants().stream()
                    .filter(party -> !Objects.equals(party, agentBank))
